...
export default function EventsSection() {
  ...
  return (
    <section id="events" className="py-20 bg-gradient-to-b from-gray-900 to-purple-900 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <div className="text-center mb-12 space-y-4">
          <Badge className="bg-purple-500/20 text-purple-200 border-purple-400/30">Upcoming Events</Badge>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Connect with industry experts, learn cutting-edge skills, and network with fellow professionals in our
            interactive workshops, bootcamps, and webinars.
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {event.isVirtual && (
                      <Badge className="bg-green-500/20 text-green-300 border-green-400/30 text-xs">Virtual</Badge>
                    )}
                  </div>
                </div>

                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-400">by {event.instructor}</div>
                </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-3xl p-8 backdrop-blur-sm border border-white/10">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Don't Miss Out!</h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Stay updated with our latest events and workshops. Join our community to get early access to exclusive
