...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-gray-900 to-purple-900 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          <Badge className="bg-purple-500/20 text-purple-200 border-purple-400/30">About Grohub</Badge>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            We're not just another learning platform. We're your partner in professional growth, offering personalized
            learning paths and real-world skills that matter.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-3xl p-8 backdrop-blur-sm border border-white/10">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Join thousands of professionals who have already accelerated their careers with Grohub. Start your journey
              today and see the difference expert guidance makes.
            </p>
