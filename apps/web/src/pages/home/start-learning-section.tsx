...
import { Play, Clock, Users, Star, BookOpen, Award, TrendingUp, ArrowRight, CheckCircle } from "lucide-react"
    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          <Badge className="bg-purple-500/20 text-purple-200 border-purple-400/30">Start Your Journey</Badge>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Follow our expertly crafted learning paths designed to take you from beginner to job-ready professional.
            Each path includes courses, projects, and career support.
          </p>
        </div>
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-lg font-bold text-white">{path.courses}</div>
                    <div className="text-xs text-gray-400">Courses</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-white">{path.projects}</div>
                    <div className="text-xs text-gray-400">Projects</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-white">{path.level.split(" ")[0]}</div>
        ...
        {/* Features Section */}
        <div className="mb-16">
          <h3 className="text-2xl md:text-3xl font-bold text-white text-center mb-8">Why Choose Our Learning Paths?</h3>
        ...
        {/* Testimonials */}
        <div className="mb-16">
          <h3 className="text-2xl md:text-3xl font-bold text-white text-center mb-8">Success Stories</h3>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-3xl p-8 backdrop-blur-sm border border-white/10">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Join thousands of learners who have transformed their careers with our structured learning paths. Start
              today and see where your new skills can take you.
            </p>
