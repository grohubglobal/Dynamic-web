  ...
  const resources = [
    {
      ...
      description:
        "Comprehensive guide covering React fundamentals, hooks, context, and advanced patterns.",
      type: "guide",
    ...
    },
    {
      ...
      description:
        "Quick reference for pandas, numpy, matplotlib, and scikit-learn functions.",
      type: "cheatsheet",
    ...
    },
    {
      ...
      description:
        "Video series covering design thinking, user research, prototyping, and testing.",
      type: "video",
      category: "Design",
      format: "MP4",
      duration: "3h 45m",
    ...
    },
    {
      ...
      description:
        "Modern JavaScript features explained with practical examples and use cases.",
      type: "ebook",
      category: "Web Development",
      format: "EPUB",
      pages: 89,
    ...
    },
    {
      ...
      description:
        "Ready-to-use code templates for common ML algorithms in Python and R.",
      type: "template",
      category: "AI/ML",
      format: "ZIP",
      files: 25,
    ...
    },
    {
      ...
      description:
        "Step-by-step learning path for iOS and Android development with resources.",
      type: "roadmap",
      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Access our comprehensive library of guides, templates, cheat sheets,
            and video tutorials to accelerate your learning journey.
          </p>
        </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-3xl p-8 backdrop-blur-sm border border-white/10">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Join our community to get access to exclusive resources,
              templates, and tools. Plus, get notified when we add new content
              to our library.
            </p>
