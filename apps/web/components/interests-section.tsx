      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover your passion and build expertise in the fields that excite
            you most. From cutting-edge technology to creative arts, we have
          ...
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-3xl p-8 backdrop-blur-sm border border-white/10 mb-12">
            <div className="text-center space-y-4">
              <h3 className="text-2xl font-bold text-white">
                Great Choice! You've selected {selectedInterests.length}{" "}
                interest
                {selectedInterests.length !== 1 ? "s" : ""}
              </h3>
              <p className="text-gray-300">
                Based on your interests, we'll recommend personalized learning
                paths and courses just for you.
              </p>
